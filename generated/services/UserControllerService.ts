...
/* tslint:disable */
/* eslint-disable */
import type { BaseResponse_ArrayList_ } from '../models/BaseResponse_ArrayList_';
...
export class UserControllerService {
    ...
    /**
     * getSignRecords
     * @returns BaseResponse_ArrayList_ OK
     * @throws ApiError
     */
    public static getSignRecordsUsingGet(): CancelablePromise<BaseResponse_ArrayList_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/get/signinfo',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
    ...
    /**
     * obtainVip
     * @param requireScore requireScore
     * @returns BaseResponse_long_ OK
     * @throws ApiError
     */
    public static obtainVipUsingGet(
        requireScore: number,
    ): CancelablePromise<BaseResponse_long_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/obtain/vip',
            query: {
     ...
     * @throws ApiError
     */
    public static signUsingPost(): CancelablePromise<BaseResponse_long_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/user/sign',
            errors: {
